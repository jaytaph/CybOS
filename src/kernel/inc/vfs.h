...
#define __VFS_H__
    ...
    struct vfs_fileops {
      Uint32(*read)(struct vfs_mount *mount, struct vfs_node *, Uint32, Uint32, char *);
      Uint32(*write)(struct vfs_mount *mount, struct vfs_node *, Uint32, Uint32, char *);
      void (*open)(struct vfs_mount *mount, struct vfs_node *);
      void (*close)(struct vfs_mount *mount, struct vfs_node *);
      struct dirent * (*readdir)(struct vfs_mount *mount, struct vfs_node *, Uint32);
      struct vfs_node * (*finddir)(struct vfs_mount *mount, struct vfs_node *, const char *);
    };
